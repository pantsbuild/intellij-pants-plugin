...
import static com.twitter.intellij.pants.testFramework.PantsTestUtils.BASE_TEST_DATA_PATH;
...
public abstract class PantsIntegrationTestCase extends ExternalSystemImportingTestCase {
  ...
  public void setUp() throws Exception {
    ...
    VfsRootAccess.allowRootAccess(myProject,
                                  ...
                                  "/usr/lib/jvm",
                                  "/workspace/.cache/pants",
                                  "/intellij-pants-plugin"); // TODO diagnostic: don't use project as disposable
  ...
  protected File getProjectFolder() {
    ...
    final File workingDir = PantsTestUtils.findTestPath(BASE_TEST_DATA_PATH).getParentFile();
  ...
  protected String getTestsTempDir() {
    return "com/twitter/intellij/pants";
  }
