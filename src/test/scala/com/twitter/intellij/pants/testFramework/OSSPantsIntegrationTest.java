...
abstract public class OSSPantsIntegrationTest extends PantsIntegrationTestCase {
  ...
  protected List<File> getProjectFoldersToCopy() {
    final File testProjects = new File(PantsTestUtils.findTestPath(PantsTestUtils.BASE_TEST_DATA_PATH), "testprojects");
  ...
  protected Document getTestData(String testDataPath) {
    ...
    VirtualFile dataVirtualFile = LocalFileSystem.getInstance().refreshAndFindFileByPath(dataFile.getPath());
