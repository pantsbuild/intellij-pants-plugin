...
export CWD=$(pwd)
export IJ_VERSION="2016.2.5"
export IJ_BUILD_NUMBER="162.2228"
...
if [[ $IJ_ULTIMATE == "true" ]]; then
  ...
  export EXPECTED_IJ_MD5="4f63ea80c9fd0129406c65cd1a02a491"
  ...
  export EXPECTED_IJ_MD5="e21daa7f3508b1482b237fd97f8c4b8f"
