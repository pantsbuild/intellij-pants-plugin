...
export CWD=$(pwd)
export IJ_VERSION="2016.2.2"
export IJ_BUILD_NUMBER="162.1628.40"
...
if [[ $IJ_ULTIMATE == "true" ]]; then
  ...
  export EXPECTED_IJ_MD5="f99319844392386ce42abac387614dd8"
  ...
  export EXPECTED_IJ_MD5="cacfd9190ae2e1c91d83b99d372846bc"
