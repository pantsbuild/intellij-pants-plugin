...
export CWD=$(pwd)
export IJ_VERSION="2017.3.1"
export IJ_BUILD_NUMBER="173.3942.27"
...
if [[ "${IJ_ULTIMATE:-false}" == "true" ]]; then
  ...
  export EXPECTED_IJ_MD5="9c465600198d76642d45e2c9fefc27d7"
  ...
  export EXPECTED_IJ_MD5="1d322650188899200b9e70b3f7d8fd56"
...
export SCALA_PLUGIN_MD5="c4672fb856eda55657fcdd99cbf82e3b"
