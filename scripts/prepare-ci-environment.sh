...
export CWD=$(pwd)
export IJ_VERSION="2016.2.1"
export IJ_BUILD_NUMBER="162.1447.26"
...
if [[ $IJ_ULTIMATE == "true" ]]; then
  ...
  export EXPECTED_IJ_MD5="27e122905e0cd2358b911abdbb44f41f"
  ...
  export EXPECTED_IJ_MD5="74aedaf61882e984bfb134a6a1db4c5b"
