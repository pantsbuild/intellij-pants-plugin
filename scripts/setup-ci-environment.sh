...
if [ ! -d .cache/intellij/$FULL_IJ_BUILD_NUMBER/plugins ]; then
  ...
  curl -LSso python.zip "https://plugins.jetbrains.com/plugin/download?pluginId=$PYTHON_PLUGIN_ID&version=$IJ_BUILD_NUMBER"
...
PANTS_PEX_DIR="testData/userHome/.cache/pants/bin/pants-pex"
